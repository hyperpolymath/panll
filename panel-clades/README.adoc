...
This template includes a complete `container/` directory with 11 ready-to-use templates for the stapeln container ecosystem. After running `just init`, the container templates have their `panel-clades` tokens replaced automatically.
