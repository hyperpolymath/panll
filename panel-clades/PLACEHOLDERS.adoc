...
|===
|Placeholder |Description |Example |Files
|`+Panll+` |Human-readable project name |`+My Project+` |SECURITY.md,
...
|`+panel-clades+` |Uppercase identifier (for Idris2 modules, C macros)
...
|`+panll+` |Repository name (slug) |`+my-project+` |CONTRIBUTING.md,
...
|`+panel-clades+` |One-line project description
...
These are *not* standard `+panel-clades+` markers – they are TODO
