    ...
    list{
      ...
      div(
        ...
        list{
          ...
          span(
            list{Attrs.class_(`w-2 h-2 rounded-full ${dotColor}`), Attrs.role("status")},
            list{},
          ),
        },
      ),
...
let renderScanRow = (scan: scanResult): Tea_Vdom.t<msg> => {
  ...
  div(
    ...
    list{
      // Pass/fail indicator
      span(list{Attrs.class_(`text-xs font-bold ${statusIcon} w-10`)}, list{text(statusText)}),
      // Repo name
      span(list{Attrs.class_("text-sm text-gray-300 w-48 truncate")}, list{text(scan.repoName)}),
      // Risk score
      span(
      ...
      div(
        ...
        list{
          span(
            list{},
            list{
              text(`${Int.toString(cycle.reposScanned)}/${Int.toString(cycle.reposTotal)} repos`),
            },
          ),
          if cycle.noveltyTriggered {
            span(list{Attrs.class_("text-amber-400")}, list{text("Novelty detected")})
          } else {
            noNode
          },
        },
...
let renderTabs = (active: hypatiaCategory): Tea_Vdom.t<msg> => {
  let tabs: array<hypatiaCategory> = [
    HypatiaDashboard,
    HypatiaScans,
    HypatiaQuarantine,
    HypatiaNeural,
          ...
          div(
            ...
            list{
              ...
              span(
                ...
                list{text("neurosymbolic CI/CD intelligence")},
              ),
              span(
                ...
                list{
                  text(
                    `${Float.toFixed(
                        HypatiaEngine.avgConfidence(hypatia.networks) *. 100.0,
                        ~digits=0,
                      )}% ensemble confidence`,
                  ),
                },
            ...
            list{
              button(
                list{
                  ...
                  KeyboardNav.onActivate(Hypatia(LoadHypatia)),
                },
                list{text("Refresh")},
              ),
              button(
          ...
          if hypatia.loading {
            ...
            div(
              ...
              list{
                ...
                div(
                  list{Attrs.class_("text-sm mb-1")},
                  list{text("Neurosymbolic CI/CD Intelligence")},
                ),
                div(
                  list{Attrs.class_("text-xs text-gray-600 mb-6")},
                  list{
                    text(
                      `5 neural networks. ${Int.toString(
                          hypatia.totalRepos,
                        )}+ repos. Safety triangle routing.`,
                    ),
                  },
                ),
                button(
                  list{
                    Attrs.class_(
                      "px-4 py-2 bg-emerald-600 text-white rounded hover:bg-emerald-500",
                    ),
                    Events.onClick(Hypatia(LoadHypatia)),
                    KeyboardNav.onActivate(Hypatia(LoadHypatia)),
                  },
                      ...
                      div(
                        ...
                        list{
                          div(
                            ...
                            list{text(`${Int.toString(hypatia.totalRepos)} repos`)},
                          ),
                          div(
                            list{Attrs.class_("text-gray-400")},
                            list{text(`${Int.toString(Array.length(hypatia.scans))} scanned`)},
                          ),
                          div(
                            list{Attrs.class_("text-gray-400")},
                            list{text(`${Int.toString(hypatia.quarantinedCount)} quarantined`)},
                          ),
                        },
                      ),
                                ...
                                div(
                                  ...
                                  list{
                                    div(
                                      list{
                                        Attrs.class_(
                                          "w-20 text-right text-xs text-red-400 font-medium",
                                        ),
                                      },
                                      list{text("Eliminate")},
                                    ),
                                    div(
                                      list{
                                        Attrs.class_(
                                          "flex-1 bg-gray-800 rounded-full h-3 overflow-hidden",
                                        ),
                                      },
                                      list{
                                        div(
                                          list{
                                            Attrs.class_(
                                              "bg-red-600 h-full rounded-full transition-all",
                                            ),
                                            Attrs.prop(
                                              "style",
                                              `width: ${Int.toString(elim * 10)}%`,
                                            ),
                                          },
                                          list{},
                                        ),
                                ...
                                div(
                                  ...
                                  list{
                                    div(
                                      list{
                                        Attrs.class_(
                                          "w-20 text-right text-xs text-amber-400 font-medium",
                                        ),
                                      },
                                    ...
                                    div(
                                      ...
                                      list{
                                        div(
                                          list{
                                            Attrs.class_(
                                              "bg-amber-600 h-full rounded-full transition-all",
                                            ),
                                            Attrs.prop(
                                              "style",
                                              `width: ${Int.toString(sub * 10)}%`,
                                            ),
                                          },
                                          list{},
                                        ),
                                ...
                                div(
                                  ...
                                  list{
                                    div(
                                      list{
                                        Attrs.class_(
                                          "w-20 text-right text-xs text-blue-400 font-medium",
                                        ),
                                      },
                                      list{text("Control")},
                                    ),
                                    div(
                                      ...
                                      list{
                                        div(
                                          list{
                                            Attrs.class_(
                                              "bg-blue-600 h-full rounded-full transition-all",
                                            ),
                                            Attrs.prop(
                                              "style",
                                              `width: ${Int.toString(ctrl * 10)}%`,
                                            ),
                                          },
                                          list{},
                                        ),
                            ...
                            div(
                              ...
                              list{
                                ...
                                div(
                                  ...
                                  list{
                                    text(`${Float.toFixed(out.successRate, ~digits=1)}% success`),
                                  },
                                ),
                                div(
                                  list{
                            ...
                            div(
                              ...
                              list{
                                ...
                                span(
                                  ...
                                  list{text("Quarantine")},
                                ),
                                span(
                                  list{Attrs.class_("flex-1 text-right")},
                                  list{text("Last Scan")},
                                ),
                              },
                            ),
                  ...
                  div(
                    ...
                    list{
                      if hypatia.quarantinedCount > 0 {
                        div(
                          list{
                            Attrs.class_("bg-amber-900/20 border border-amber-700 rounded-lg p-4"),
                          },
                          list{
                            div(
                              ...
                              list{
                                span(
                                  ...
                                  list{
                                    text(
                                      `${Int.toString(hypatia.quarantinedCount)} items quarantined`,
                                    ),
                                  },
                                ),
                              },
                            ...
                            div(
                              ...
                              list{
                                text(
                                  "These items have been held for human review. Connect to the Hypatia backend to inspect and resolve individual quarantine entries.",
                                ),
                              },
                            ),
                          },
                        ...
                        div(
                          ...
                          list{
                            ...
                            div(
                              ...
                              list{
                                text(
                                  "No items in quarantine. All findings have been routed through the safety triangle.",
                                ),
                              },
                            ),
                          },
                    ...
                    list{
                      {
                        ...
                        let withFix =
                          hypatia.recipeEntries->Array.filter(r => r.hasFixScript)->Array.length
                        let elimCount =
                          hypatia.recipeEntries
                          ->Array.filter(r => r.tier === Eliminate)
                          ->Array.length
                        let subCount =
                          hypatia.recipeEntries
                          ->Array.filter(r => r.tier === Substitute)
                          ->Array.length
                        let ctrlCount =
                          hypatia.recipeEntries->Array.filter(r => r.tier === Control)->Array.length
                        div(
                          list{Attrs.class_("flex gap-4 text-xs flex-wrap")},
                          list{
                            div(
                              list{Attrs.class_("text-gray-300 font-medium")},
                              list{text(`${Int.toString(total)} recipes`)},
                            ),
                            div(
                              list{Attrs.class_("text-green-400")},
                              list{text(`${Int.toString(withFix)} with fix_script`)},
                            ),
                            div(
                              list{Attrs.class_("text-red-400")},
                              list{text(`${Int.toString(elimCount)} eliminate`)},
                            ),
                            div(
                              list{Attrs.class_("text-amber-400")},
                              list{text(`${Int.toString(subCount)} substitute`)},
                            ),
                            div(
                              list{Attrs.class_("text-blue-400")},
                              list{text(`${Int.toString(ctrlCount)} control`)},
                            ),
                          },
                        )
                      },
                      ...
                      {
                        let filtered = HypatiaEngine.filterRecipes(
                          hypatia.recipeEntries,
                          hypatia.recipeFilter,
                        )
                        div(
                          ...
                          list{
                            ...
                            div(
                              ...
                              list{
                                ...
                                div(
                                  list{
                                    Attrs.class_(
                                      "flex items-center gap-2 p-2 bg-gray-900 border-b border-gray-700 text-xs text-gray-500",
                                    ),
                                  },
                                  list{
                                    ...
                                    span(
                                      list{Attrs.class_("w-14 text-right")},
                                      list{text("Fired")},
                                    ),
                                  },
                                ),
                                div(
                                  ...
                                  ->Array.map(recipe => {
                                    ...
                                    div(
                                      list{
                                        Attrs.class_(
                                          `flex items-center gap-2 p-2 cursor-pointer transition-colors ${isSelected
                                      ...
                                      list{
                                        ...
                                        span(
                                          list{
                                            Attrs.class_(
                                              `w-6 text-center text-xs ${recipe.hasFixScript
                                                  ? "text-green-500"
                                                  : "text-gray-700"}`,
                                            ),
                                          },
                                        ...
                                        span(
                                          list{
                                            Attrs.class_("flex-1 text-sm text-gray-300 truncate"),
                                          },
                                        ...
                                        span(
                                          list{
                                            Attrs.class_(
                                              `w-12 text-right text-xs ${recipe.confidence >= 0.97
                                                  ? "text-emerald-400"
                                                  : recipe.confidence >= 0.93
                                                  ? "text-amber-400"
                                                  : "text-red-400"}`,
                                            ),
                                          },
                                        ...
                                        span(
                                          list{
                                            Attrs.class_(
                                              "w-14 text-right text-xs text-gray-500 font-mono",
                                            ),
                                          },
                            ...
                            | Some(recipeId) =>
                              ...
                              | Some(recipe) =>
                                div(
                                  list{
                                    Attrs.class_(
                                      `w-80 border rounded-lg p-4 space-y-4 ${HypatiaEngine.tierBg(
                                          recipe.tier,
                                        )}`,
                                    ),
                                  ...
                                  list{
                                      ...
                                      list{
                                        div(
                                          ...
                                          list{
                                            div(
                                              list{
                                                Attrs.class_("text-sm font-medium text-gray-200"),
                                              },
                                              list{text(recipe.name)},
                                            ),
                                            div(
                                    ...
                                    div(
                                      ...
                                      list{
                                        ...
                                        div(
                                          list{
                                            Attrs.class_(
                                              `font-mono ${recipe.confidence >= 0.97
                                                  ? "text-emerald-400"
                                                  : "text-amber-400"}`,
                                            ),
                                          },
                                        ...
                                        div(
                                          list{Attrs.class_("text-gray-500")},
                                          list{text("Last triggered")},
                                        ),
                                        div(
                                          list{Attrs.class_("text-gray-400")},
                                          list{text(recipe.lastTriggered)},
                                        ),
                                      },
                                    ),
                                    // Languages
                                        ...
                                        div(
                                          ...
                                          ->Array.map(lang =>
                                            span(
                                              list{
                                                Attrs.class_(
                                                  "px-2 py-0.5 text-xs bg-gray-800/80 text-gray-300 rounded border border-gray-700",
                                                ),
                                              },
                                              list{text(lang)},
                                            )
                                    ...
                                    div(
                                      ...
                                      list{
                                        div(
                                          list{Attrs.class_("text-xs text-gray-500")},
                                          list{text("Confidence gauge")},
                                        ),
                                        div(
                                          list{
                                            Attrs.class_("w-full bg-gray-800/60 rounded-full h-2"),
                                          },
                                          list{
                                            div(
                                              list{
                                                Attrs.class_(
                                                  `h-full rounded-full transition-all ${recipe.confidence >= 0.97
                                                      ? "bg-emerald-500"
                                                      : recipe.confidence >= 0.93
                                                      ? "bg-amber-500"
                                                      : "bg-red-500"}`,
                              ...
                              | None =>
                                div(
                                  list{
                                    Attrs.class_(
                                      "w-80 border border-gray-700 rounded-lg p-4 text-xs text-gray-500",
                                    ),
                                  },
                            ...
                            | None =>
                              div(
                                list{
                                  Attrs.class_(
                                    "w-80 border border-gray-700 rounded-lg p-6 flex items-center justify-center",
                                  ),
                                },
                                list{
                                  div(
