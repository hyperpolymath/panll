        ...
        list{
          button(
            list{
              ...
              KeyboardNav.onActivate(Databases(ConnectAll)),
          ...
          button(
            list{
              ...
              KeyboardNav.onActivate(Databases(RefreshHealth)),
            ...
            list{
              ...
              button(
                list{
                  ...
                  KeyboardNav.onActivate(Databases(ToggleBojRouting)),
            ...
            list{
              button(
                list{
                  ...
                  KeyboardNav.onActivate(Databases(ExecuteQuery)),
              ...
              button(
                list{
                  ...
                  KeyboardNav.onActivate(Databases(ClearQuery)),
            ...
            list{
                    ...
                    list{
                      ...
                      button(
                        list{
                          ...
                          KeyboardNav.onActivate(Databases(RefreshDrift)),
              ...
              button(
                list{
                  ...
                  KeyboardNav.onActivate(Databases(NormaliseAll)),
              ...
              list{
                ...
                button(
                  list{
                    ...
                    KeyboardNav.onActivate(Databases(LoadTelemetry)),
              ...
              list{
                ...
                button(
                  list{
                    ...
                    KeyboardNav.onActivate(Databases(DismissError)),
                  },
                  list{text("dismiss")},
                ),
              },
