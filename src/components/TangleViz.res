        ...
        list{
          button(
            list{
              ...
              KeyboardNav.onActivate(TangleViz(ParseInput)),
            },
            list{text("Parse")},
          ),
          button(
            list{
              ...
              KeyboardNav.onActivate(TangleViz(ClearAll)),
            },
            list{text("Clear")},
          ),
        },
          ...
          list{
            button(
              list{
                ...
                KeyboardNav.onActivate(TangleViz(ComputeInvariant)),
              },
              list{text("Compute")},
            ),
            // Result display
      ...
      list{
        ...
        button(
          list{
            ...
            KeyboardNav.onActivate(TangleViz(DismissError)),
          },
          list{text("dismiss")},
        ),
      },
