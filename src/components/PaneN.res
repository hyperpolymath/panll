              ...
              if hasActiveFilters {
                button(
                  list{
                    ...
                    KeyboardNav.onActivate(PaneN(ClearFilters)),
                  },
                  list{text("Clear")},
                )
              } else {
        ...
        list{
          ...
          button(
            list{
              ...
              KeyboardNav.onActivate(PaneN(ToggleValidatedOnly)),
          ...
          button(
            list{
              ...
              KeyboardNav.onActivate(PaneN(ToggleProofOnly)),
    ...
    list{
      ...
      button(
        list{
          ...
          KeyboardNav.onActivate(Echidna(CheckHealth)),
        },
        list{text("Ping")},
      ),
    },
          ...
          list{
            ...
            button(
              list{
                ...
                KeyboardNav.onActivate(Echidna(ListProvers)),
              },
        ...
        list{
          button(
            list{
              ...
              KeyboardNav.onActivate(Echidna(SubmitProof)),
            },
          ...
          button(
            list{
              ...
              KeyboardNav.onActivate(Echidna(SubmitVerify)),
            },
        ...
        list{
          button(
            list{
              ...
              KeyboardNav.onActivate(Echidna(ClearProofResult)),
            },
            list{text("Clear")},
          ),
        },
      ...
      list{
        button(
          list{
            ...
            KeyboardNav.onActivate(Echidna(CreateSession)),
          },
      ...
      list{
        button(
          list{
            ...
            KeyboardNav.onActivate(Echidna(CancelSession)),
          },
        ...
        button(
          list{
            ...
            KeyboardNav.onActivate(Echidna(GetSessionState)),
          },
          list{text("Refresh")},
        ),
      },
        ...
        list{
          button(
            list{
              ...
              KeyboardNav.onActivate(Echidna(ImportXmiModel)),
            },
          ...
          button(
            list{
              ...
              KeyboardNav.onActivate(Echidna(RunOclCheck)),
            },
          ...
          button(
            list{
              ...
              KeyboardNav.onActivate(Echidna(ClearEnterpriseModel)),
            },
            list{text("Clear")},
          ),
        },
    ...
    list{
      ...
      button(
        list{
          ...
          KeyboardNav.onActivate(Echidna(ToggleMenu)),
        },
        list{
          div(
          ...
          list{
            ...
            button(
              list{
                ...
                KeyboardNav.onActivate(VeriSimDB(ClearInferenceSuggestions)),
              },
              list{text("Clear")},
            ),
          },
