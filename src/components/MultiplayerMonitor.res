                ...
                list{
                  ...
                  | WsDisconnected | WsError(_) =>
                    button(
                      list{
                        ...
                        KeyboardNav.onActivate(MultiplayerMonitor(ConnectServer)),
                      },
                      list{text("Connect")},
                    )
                  ...
                  button(
                    list{
                      ...
                      KeyboardNav.onActivate(MultiplayerMonitor(RefreshState)),
                    },
                    list{text("Refresh")},
                  ),
                },
        ...
        list{
          ...
          button(
            list{
              ...
              KeyboardNav.onActivate(MultiplayerMonitor(RefreshDiffs)),
            },
            list{text("Refresh")},
          ),
        },
            ...
            list{
              button(
                list{
                  ...
                  KeyboardNav.onActivate(MultiplayerMonitor(ToggleSpectators)),
                },
              ...
              button(
                list{
                  ...
                  KeyboardNav.onActivate(MultiplayerMonitor(ReconnectionTest)),
                },
              ...
              list{
                ...
                button(
                  list{
                    ...
                    KeyboardNav.onActivate(MultiplayerMonitor(DismissMultiplayerError)),
                  },
                  list{text("Dismiss")},
                ),
              },
