...
let progressBar = (adoption: toolAdoption): Tea_Vdom.t<msg> => {
  ...
  div(
    ...
    list{
      ...
      div(
        list{Attrs.class_("w-full bg-gray-800 rounded-full h-2")},
        list{
          div(
            list{
      ...
      div(
        ...
        list{
          ...
          if adoption.campaignActive {
            span(
              list{Attrs.class_("text-xs text-blue-400 animate-pulse")},
              list{text("Campaign Active")},
            )
          } else {
            noNode
          },
...
let outcomeRow = (outcome: dispatchOutcome): Tea_Vdom.t<msg> => {
  let statusColor = if outcome.success {
    "text-green-400"
  } else {
    "text-red-400"
  }
  let statusLabel = if outcome.success {
    "OK"
  } else {
    "FAIL"
  }
  div(
    ...
    list{
      ...
      span(
        list{Attrs.class_("text-gray-400 w-32 shrink-0 truncate")},
        list{text(outcome.fixScript)},
      ),
  ...
  div(
    ...
    list{
          ...
          div(
            ...
            list{
              ...
              span(
                ...
                list{text(`Overall: ${progressStr}% | ${Int.toString(state.totalRepos)} repos`)},
              ),
            },
          ),
          div(
            ...
            div(
              ...
              ->Array.map(a =>
                div(
                  list{
                    Attrs.class_(
                      "flex items-center justify-between py-2 px-3 border-b border-gray-800",
                    ),
                  },
                  list{
                    ...
                    div(
                      ...
                      list{
                        span(
                          list{Attrs.class_("text-xs text-gray-400")},
                          list{text(`${Float.toFixed(a.percentage, ~digits=1)}% adopted`)},
                        ),
                        button(
                          list{
                            Attrs.class_(
                              "px-2 py-1 text-xs rounded bg-blue-700 text-white hover:bg-blue-600",
                            ),
                ...
                div(
                  ...
                  list{
                    ...
                    span(
                      ...
                      list{text(`${Int.toString(a.targetCount - a.adoptedCount)} repos missing`)},
                    ),
                  },
                )
              )
      ...
      div(
        list{
          Attrs.class_(
            "px-4 py-2 border-t border-gray-800 text-xs text-gray-500 flex justify-between",
          ),
        },
        list{
          span(
          ...
          span(
            ...
            list{
              text(
                `${Int.toString(FloorRaiseEngine.successCount(state.outcomes))}/${Int.toString(
                    Array.length(state.outcomes),
