      ...
      | GamePaused | GameStepping =>
        button(
          list{
            ...
            KeyboardNav.onActivate(GamePreview(StepFrame)),
          },
            ...
            list{
                  ...
                  list{
                    ...
                    button(
                      list{
                        ...
                        KeyboardNav.onActivate(GamePreview(StopGameRecording)),
                      },
                      list{text("Stop")},
                    ),
                  },
              ...
              | GameRecordingIdle =>
                button(
                  list{
                    ...
                    KeyboardNav.onActivate(GamePreview(StartGameRecording)),
                  },
                  list{text("Record")},
                )
              },
              ...
              button(
                list{
                  ...
                  KeyboardNav.onActivate(GamePreview(ScreenshotGame)),
                },
              ...
              button(
                list{
                  ...
                  KeyboardNav.onActivate(GamePreview(ToggleMultiplayerView)),
                },
              ...
              list{
                ...
                button(
                  list{
                    ...
                    KeyboardNav.onActivate(GamePreview(CheckDevServer)),
                  },
        ...
        list{
          ...
          button(
            list{
              ...
              KeyboardNav.onActivate(GamePreview(ClearDeviceLog)),
            },
            list{text("Clear")},
          ),
        },
        ...
        list{
          ...
          button(
            list{
              ...
              KeyboardNav.onActivate(GamePreview(LoadClips)),
            },
            list{text("Refresh")},
          ),
        },
        ...
        list{
          ...
          button(
            list{
              ...
              KeyboardNav.onActivate(GamePreview(RefreshStats)),
            },
            list{text("Refresh")},
          ),
        },
