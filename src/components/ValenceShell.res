            ...
            list{
                  ...
                  list{
                    ...
                    button(
                      list{
                        ...
                        KeyboardNav.onActivate(ValenceShell(StopRecordingSession)),
                      },
                      list{text("Stop")},
                    ),
                  },
              ...
              | RecordingIdle =>
                button(
                  list{
                    ...
                    KeyboardNav.onActivate(ValenceShell(StartRecordingSession)),
                  },
                  list{text("Record")},
                )
              },
              ...
              button(
                list{
                  ...
                  KeyboardNav.onActivate(ValenceShell(ScreenshotTerminal)),
                },
        ...
        list{
          ...
          button(
            list{
              ...
              KeyboardNav.onActivate(ValenceShell(LoadRecordings)),
            },
            list{text("Refresh")},
          ),
        },
            ...
            list{
              ...
              button(
                list{
                  ...
                  KeyboardNav.onActivate(ValenceShell(LoadCheckpoints)),
                },
                list{text("Refresh")},
              ),
            },
        ...
        list{
          ...
          button(
            list{
              ...
              KeyboardNav.onActivate(ValenceShell(ToggleSplitView)),
            },
              ...
              if !state.claudeCodeActive {
                button(
                  list{
                    ...
                    KeyboardNav.onActivate(ValenceShell(LaunchClaudeCode)),
                  },
              ...
              list{
                ...
                button(
                  list{
                    ...
                    KeyboardNav.onActivate(ValenceShell(DismissError)),
                  },
                  list{text("Dismiss")},
                ),
              },
