  ...
  button(
    ...
    list{
      ...
      div(
        ...
        list{text(`${Int.toString(Array.length(repo.modules))} modules`)},
      ),
    },
  )
}
...
/// Render a tab button.
let tabBtn = (current: provenAdoptionTab, target: provenAdoptionTab, label: string): Tea_Vdom.t<
  msg,
> => {
  ...
  div(
    ...
    list{
      ...
      div(
        ...
        list{
          div(
            ...
            list{
              h2(
                list{Attrs.class_("text-lg font-bold text-green-300")},
                list{text("Proven Adoption")},
              ),
              span(
                list{Attrs.class_("text-xs text-gray-500")},
                list{text(`${Int.toString(adopted)}/${Int.toString(total)} repos`)},
              ),
            },
          ),
          button(
      ...
      div(
        ...
        ProvenAdoptionEngine.allTabs
        ->Array.map(t => tabBtn(state.activeTab, t, ProvenAdoptionEngine.tabLabel(t)))
        ->List.fromArray,
      ),
      // Error banner
      switch state.error {
                      ...
                      div(
                        ...
                        list{
                          div(
                            ...
                            list{
                              span(
                                list{Attrs.class_("text-xs text-gray-500 w-32")},
                                list{text("Dependency:")},
                              ),
                              span(
                                list{
                                  Attrs.class_(
                                    if repo.dependencyDeclared {
                          ...
                          div(
                            ...
                            list{
                              span(
                                list{Attrs.class_("text-xs text-gray-500 mb-1 block")},
                                list{text("Modules:")},
                              ),
                              div(
                                ...
                                ->Array.map(m =>
                                  span(
                                    list{
                                      Attrs.class_(
                                        "px-2 py-0.5 text-xs bg-gray-800 rounded text-gray-300",
                                      ),
                                    },
                                    list{text(m)},
                                  )
      ...
      div(
        ...
        list{
          text(
            `${Int.toString(ProvenAdoptionEngine.fullyBoundCount(state.repos))} repos fully bound`,
          ),
        },
      ),
    },
