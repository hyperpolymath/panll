      ...
      list{
        ...
        button(
          list{
            ...
            KeyboardNav.onActivate(LevelArchitect(BrowseAssets)),
          },
        ...
        list{
          button(
            list{
              ...
              KeyboardNav.onActivate(LevelArchitect(ValidateLevel)),
            },
            ...
            list{
              ...
              button(
                list{
                  ...
                  KeyboardNav.onActivate(LevelArchitect(UndoAction)),
                },
                list{text("Undo")},
              ),
              button(
                list{
                  ...
                  KeyboardNav.onActivate(LevelArchitect(RedoAction)),
                },
                list{text("Redo")},
              ),
              // Toggle grid lines
              button(
                list{
                  ...
                  KeyboardNav.onActivate(LevelArchitect(ToggleGrid)),
                },
                list{text("Grid")},
              ),
              // Toggle patrol paths
              button(
                list{
                  ...
                  KeyboardNav.onActivate(LevelArchitect(TogglePatrolPaths)),
                },
                list{text("Patrols")},
              ),
            },
              ...
              list{
                ...
                button(
                  list{
                    ...
                    KeyboardNav.onActivate(LevelArchitect(DismissArchitectError)),
                  },
                  list{text("Dismiss")},
                ),
              },
