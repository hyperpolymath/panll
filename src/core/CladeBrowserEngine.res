...
let filterClades = (clades: array<cladeEntry>, kind: cladeKind, query: string): array<
  cladeEntry,
> => {
...
let builtinCladesBase: array<cladeEntry> = [
  {
    ...
    sbom: None,
    sandbox: None,
    siblingClades: ["cloudguard", "network-topology"],
  },
  {
    id: "ai",
    name: "AI",
  ...
  },
  {
    ...
    panelIds: ["PanelAutomationRouter"],
    consumedBy: [],
    supersedes: [],
    parentCladeId: None,
    protocols: [],
  ...
  },
  {
    ...
    panelIds: ["PanelScriptGist"],
    consumedBy: ["automation-router", "boj"],
    supersedes: [],
    parentCladeId: None,
    protocols: [],
    capabilities: [],
    requires: [],
    enhances: ["automation-router", "playgrounds"],
    isolation: IsolationSoft,
    signing: SigningNone,
    sbom: None,
    sandbox: None,
    siblingClades: ["playgrounds", "automation-router"],
  },
  {
    id: "boj",
    ...
    panelIds: ["PanelBoj"],
    consumedBy: ["aerie", "ai", "databases"],
    supersedes: ["polystack"],
    parentCladeId: Some("bridge"),
    protocols: [],
    capabilities: [],
    requires: [],
    enhances: [],
    ...
    sbom: None,
    sandbox: None,
    siblingClades: ["ai", "databases", "network-topology"],
  },
  {
    id: "build-dashboard",
  ...
  },
  {
    ...
    sbom: None,
    sandbox: None,
    siblingClades: ["level-architect", "dlc-workshop"],
  },
  {
    id: "editor-bridge",
    name: "Editor Bridge",
  ...
  },
  {
    ...
    panelIds: ["PanelMassPanic"],
    consumedBy: [],
    supersedes: [],
    parentCladeId: Some("scanner"),
    protocols: [],
    capabilities: [],
    requires: [],
    enhances: [],
  ...
  },
  {
    ...
    panelIds: ["PanelMultiplayerMonitor"],
    consumedBy: [],
    supersedes: [],
    parentCladeId: None,
    protocols: [],
  ...
  },
  {
    ...
    panelIds: ["PanelProtocolSquisher"],
    consumedBy: ["boj"],
    supersedes: [],
    parentCladeId: Some("scanner"),
    protocols: [],
    ...
    sbom: None,
    sandbox: None,
    siblingClades: ["aerie", "interfaces"],
  },
  {
    id: "my-lang",
    name: "My-Lang",
    ...
    sbom: None,
    sandbox: None,
    siblingClades: ["build-dashboard", "editor-bridge"],
  },
  {
    id: "typell",
    name: "TypeLL — Verification Kernel",
    kind: "ai",
    version: "1.0.0",
    ...
    panelIds: ["PanelTypeLL"],
    consumedBy: ["databases", "protocol-squisher", "my-lang", "boj", "playgrounds"],
    supersedes: [],
    parentCladeId: None,
    protocols: [],
    capabilities: [],
    ...
    sbom: None,
    sandbox: None,
    siblingClades: ["ai", "clade-tentacles"],
  },
  {
    id: "echidna",
    name: "ECHIDNA",
  ...
  },
  {
    ...
    sbom: None,
    sandbox: None,
    siblingClades: ["security", "panic-attack"],
  },
  {
    id: "feedback",
  ...
  },
  {
    ...
    sbom: None,
    sandbox: None,
    siblingClades: ["workspace", "accessibility"],
  },
  {
    id: "tiling",
    name: "Tiling",
  ...
  },
  {
    ...
    sbom: None,
    sandbox: None,
    siblingClades: ["workspace", "minter"],
  },
  {
    id: "observatory",
    name: "Observatory",
    ...
    sbom: None,
    sandbox: None,
    siblingClades: ["build-dashboard", "workspace"],
  },
  {
    id: "ambientops",
    name: "AmbientOps",
    ...
    sbom: None,
    sandbox: None,
    siblingClades: ["aerie", "cloudguard"],
  },
]
  ...
  if visited->Array.some(v => v == cladeId) {
    ...
    | Some(clade) =>
      ...
      | Some(parentId) =>
        Array.concat(
          [cladeId],
          inheritanceChain(clades, parentId, Array.concat(visited, [cladeId])),
        )
      }
    }
  }
...
let findPermissionRule = (rules: array<cladePermissionRule>, targetCladeId: string): option<
  cladePermissionRule,
> => {
...
let canReference = (
  ...
  if sourceCladeId == targetCladeId {
    ...
    | Some({permission: PermitOnly(allowed)}) => allowed->Array.some(id => id == sourceCladeId)
    }
  }
}
...
let canPanelReference = (
  ...
  let sourceCladeId =
    clades
    ->Array.find(c => c.panelIds->Array.some(p => p == sourcePanelId))
    ->Option.map(c => c.id)
  let targetCladeId =
    clades
    ->Array.find(c => c.panelIds->Array.some(p => p == targetPanelId))
    ->Option.map(c => c.id)
...
let removePermission = (rules: array<cladePermissionRule>, targetCladeId: string): array<
  cladePermissionRule,
> => {
      ...
      ~requires=[
        {
          ...
          required: true,
          reason: "UMS validates levels via Level Architect's Idris2 ABI",
        },
      ],
      entry,
    )
      ...
      ~requires=[
        {
          cladeId: "databases",
          required: false,
          reason: "VeriSimDB backing store for proof certificates",
        },
      ],
...
let isSandboxed = (clade: cladeEntry): bool => clade.sandbox !== None
...
let hasSbom = (clade: cladeEntry): bool => clade.sbom !== None

/// Count clades with SBOMs.
let countWithSbom = (clades: array<cladeEntry>): int => clades->Array.filter(hasSbom)->Array.length
...
let sandboxViolations = (clade: cladeEntry): array<cladeCapability> =>
  ...
  | None => []
  | Some(sandbox) => clade.capabilities->Array.filter(cap => !sandboxAllows(sandbox, cap))
  }
