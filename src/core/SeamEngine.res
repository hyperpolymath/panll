...
let knownPanllSeams: array<seam> = [
  ...
  },
  {
    ...
    actualBehaviour: "PanLL uses Rust for backend FFI via Gossamer commands, no Idris2/Zig layer",
    rationale: "Gossamer mandates Rust backend. Coprocessor Phase 2/3 simulates Zig FFI in Rust. Actual Zig FFI planned for coprocessor hardware data plane.",
    scope: "Entire Gossamer backend. Coprocessor engine has routing stubs for future Zig FFI.",
  ...
  // ==========================================================================
  {
    ...
    category: IntegrationBoundary,
    severity: High,
    policyExpectation: "UMS panel has a Rust backend with ums_* Gossamer commands registered",
    actualBehaviour: "UMS Rust backend commands must be verified present in Gossamer command registry",
    ...
    scope: "UMS Gossamer commands only (ums_* namespace). Does not cover other panel backends.",
