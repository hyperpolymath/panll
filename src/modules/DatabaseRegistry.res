...
let verisimdb: moduleConfig = {
  ...
  playground: Some({
    ...
    exampleQueries: [
      { label: "List hexads", query: "SELECT * FROM hexads LIMIT 10", isDependentType: false },
      ...
      { label: "Multi-proof", query: "SELECT * FROM hexads PROOF EXISTENCE(e) AND INTEGRITY(e) AND FRESHNESS(e) LIMIT 5", isDependentType: true },
    ],
