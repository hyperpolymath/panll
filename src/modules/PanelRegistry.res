...
let allPanels: array<panelMeta> = [
  ...
  // ════════════════════════════════════════════════════════════════════════
  {
    id: PanelGsaServerBrowser,
    name: "Server Browser",
    shortName: "Servers",
    description: "Discover and fingerprint game servers",
    icon: "radar",
    connectionStatus: ServiceConnected,
    hasBackend: true,
    cladeId: Some("gsa-browser"),
  },
  {
    id: PanelGsaConfigEditor,
    name: "Config Editor",
    shortName: "Config",
    description: "A2ML-aware game server configuration editor",
    icon: "sliders",
    connectionStatus: ServiceConnected,
    hasBackend: true,
    cladeId: Some("gsa-config"),
  },
  {
    id: PanelGsaServerActions,
    name: "Server Actions",
    shortName: "Actions",
    description: "Start/stop/restart game servers with confirmation",
    icon: "play-circle",
    connectionStatus: ServiceConnected,
    hasBackend: true,
    cladeId: Some("gsa-actions"),
  },
  {
    id: PanelGsaLiveLogs,
    name: "Live Logs",
    shortName: "Logs",
    description: "Real-time game server log streaming",
    icon: "terminal",
    connectionStatus: ServiceConnected,
    hasBackend: true,
    cladeId: Some("gsa-logs"),
  },
  {
    id: PanelGsaHealthDashboard,
    name: "Health Dashboard",
    shortName: "Health",
    description: "Server health and config drift detection",
    icon: "activity",
    connectionStatus: ServiceConnected,
    hasBackend: true,
    cladeId: Some("gsa-health"),
  },
  {
    id: PanelGsaConfigHistory,
    name: "Config History",
    shortName: "History",
    description: "Config version timeline with provenance chain",
    icon: "git-branch",
    connectionStatus: ServiceConnected,
    hasBackend: true,
    cladeId: Some("gsa-history"),
  },
  {
